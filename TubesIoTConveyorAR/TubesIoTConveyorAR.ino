...
void loop() {
  bool stateButton = fb.getBool("ButtonState/state");
  int power = fb.getInt("TubesIoT/power/value");  //Power dalam persen
  ...
  if (conveyorRunning) {
    motorBackward(motorSpeed);  // Conveyor berjalan mundur dengan kecepatan yang ditentukan
